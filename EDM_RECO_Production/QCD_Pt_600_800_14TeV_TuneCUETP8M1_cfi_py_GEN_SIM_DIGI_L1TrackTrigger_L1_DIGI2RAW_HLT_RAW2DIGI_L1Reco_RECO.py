...
# with command line options: Configuration/Generator/python/QCD_Pt_600_800_14TeV_TuneCUETP8M1_cfi.py --conditions auto:phase2_realistic_T21 -s GEN,SIM,DIGI:pdigi_valid,L1TrackTrigger,L1,DIGI2RAW,HLT:@fake2,RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-DIGI-RAW-RECO -n 1 --geometry Extended2026D77 --pileup NoPileUp --beamspot HLLHC --eventcontent FEVTDEBUGHLT --era Phase2C11I13M9 --fileout file:/eos/user/z/zhenggan/JetTaggingwithHGCal/test/0001.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/QCD_Pt_600_800_14TeV_TuneCUETP8M1_cfi.py nevts:1'),
